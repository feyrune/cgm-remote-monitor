...
/*
		...
		console.log("Requesting if CanFulfillIntent");
		//console.log(req.body.request.
		res.json({"canFulfill":"NO"});
			next( );
		break;
*/
            case 'IntentRequest':
...
/*
    ctx.alexa.configureIntentHandler('CanFulfillIntentRequest', function(callback, slots, sbx, locale) {
	    console.log("Inside CanFulfillmentIntentRequest handler");
    };
*/
